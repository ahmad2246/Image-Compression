# -*- coding: utf-8 -*-
"""reorgnized_code.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1W2kpVPkNqUX3Hl6bMlIHfClRpq_vYS3E
"""
...
def add_salt_and_pepper_noise(image):
    ...
    noisy_image[coords] = 255  # Add salt noise
    num_pepper = np.ceil(amount * image.size * 0.5)
    coords = [np.random.randint(0, i - 1, int(num_pepper)) for i in image.shape]
    noisy_image[coords] = 0  # Add pepper noise
    return noisy_image
...
def processing(folder_name, new_folder_name):
    ...
    def calculate_metrics(parameters):
        ...
        for img_name, img_path, jpg_path, png_path, webp_path in zip(parameters["images_names"], parameters["images_full_path"], parameters["jpg_full_path"], parameters["png_full_path"], parameters["webp_full_path"]):
            ...
            # Write CR
            results_file.write("Compresion Ratio:\n")
            ...
            # Store SSIM
            SSIM["jpg"].append(metrics.structural_similarity(img_arr, jpg_arr, data_range=None, multichannel=True))
            SSIM["png"].append(metrics.structural_similarity(img_arr, png_arr, data_range=None, multichannel=True))
            SSIM["webp"].append(metrics.structural_similarity(img_arr, webp_arr, data_range=None, multichannel=True))
